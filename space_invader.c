...
void art()
{
    ...
    printf(" |_____/|_| /_/    \\_\\_____|______|______ _____  \n");
    printf(" |_   _| \\ | \\ \\    / /\\   |  __ \\|  ____|  __ \\  \n");
    printf("   | | |  \\| |\\ \\  / /  \\  | |  | | |__  | |__) | \n");
    printf("   | | | . ` | \\ \\/ / /\\ \\ | |  | |  __| |  _  /  \n");
    printf("  _| |_| |\\  |  \\  / ____ \\| |__| | |____| | \\ \\  \n");
    printf(" |_____|_| \\_|   \\/_/    \\_\\_____/|______|_|  \\_\\ \n");
    printf(" \n");
    printf(" \n");
    printf(" \n");
    printf(" \n");
...
int main()
{
    ...
    Sleep(2500);
    printf("Your World is depending upon you. \n Controls: press 'a' and 'd' to move left and right \n Press 'm' to fire\n \n");
    Sleep(2500);
    printf("               Good luck.");
    Sleep(1000);
